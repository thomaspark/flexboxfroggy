var docs = {
  'align-content': {
    ...
    'uk': '<p>Вирівнює ряди flex-контейнера, що знаходяться всередині нього (cпрацьовує тільки якщо елементів у контейнері більше ніж на один ряд).</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>stretch</code>'
  },
  'align-items': {
    ...
    'uk': '<p>Вирівнює flex-елементи, що розташовані відносно поперечної вісі (тої, що є перпендикулярною до основної).</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>baseline</code> <code>stretch</code>'
  },
  'align-self': {
    ...
    'uk': '<p>Вирівнює flex-елемент вздовж поперечної вісі (тої, що є перпендикулярною до основної), перекриваючи значення властивості <code>align-items</code>.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>baseline</code> <code>stretch</code>'
  },
  'flex-direction': {
    ...
    'uk': '<p>Задає напрям основної вісі.</p><code>row</code> <code>row-reverse</code> <code>column</code> <code>column-reverse</code>'
  },
  'flex-flow': {
    ...
    'uk': '<p>Псевдонім (скорочений запис) для <code>flex-direction</code> та <code>flex-wrap</code>.</p><code>&lt;flex-direction&gt; &lt;flex-wrap&gt;</code>'
  },
  'flex-wrap': {
    ...
    'uk': '<p>Використовується для того, щоб визначити чи потрібно примусово тримати елементи в одному ряду або можна перенести їх у декілька.</p><code>nowrap</code> <code>wrap</code> <code>wrap-reverse</code>'
  },
  'justify-content': {
    ...
    'uk': '<p>Вирівнює flex-елементи вздовж головної вісі.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code>'
  },
  'order': {
    ...
    'uk': '<p>Вказує порядок flex-елемента.</p><code>&lt;integer&gt;</code>'
  }
};
