var docs = {
  'align-content': {
    'afr': '<p>Rig die flex houer se lyne binne die flex houer wanneer daar ekstra spasie is op die kruis-as. </p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>space-evenly</code> <code>stretch (verstek)</code>',
  ...
  'align-items': {
    'afr': '<p>Rig flex items op die kruis-as.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>baseline</code> <code>stretch (verstek)</code>',
  ...
  'align-self': {
    'afr': '<p>Rig `n flex item op die kruis-as, en oorskryf die <code>align-items</code> waarde.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>baseline</code> <code>stretch</code>',
  ...
  'flex-direction': {
    'afr': '<p>Bepaal die direksie van die hoof as.</p><code>row (verstek)</code> <code>row-reverse</code> <code>column</code> <code>column-reverse</code>',
  ...
  'flex-flow': {
    'afr': '<p>Kortskrif eienskap vir <code>flex-direction</code> en <code>flex-wrap</code>.</p><code>&lt;flex-direction&gt; &lt;flex-wrap&gt;</code>',
  ...
  'flex-wrap': {
    'afr': '<p>Spesifiseer of die flex items op `n enkele lyn geforseer is of oor meerdere lyne gevou word.</p><code>nowrap (verstek)</code> <code>wrap</code> <code>wrap-reverse</code>',
  ...
  'justify-content': {
    'afr': '<p>Rig die flex items op die hoof as.</p><code>flex-start (verstek)</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>space-evenly</code>',
  ...
  'order': {
    'afr': '<p>Spesifiseer die orde van die flex item.</p><code>&lt;integer&gt; (... -1, 0 (verstek), 1, ...)</code>',
