var docs = {
  'align-content': {
    ...
    'te': '<p>క్రాస్-యాక్సిస్‌లో అదనపు స్థలం ఉన్నప్పుడు ఫ్లెక్స్ కంటైనర్‌లోని పంక్తులను సమలేఖనం చేస్తుంది. </p><code>flex-start</code><code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>stretch (default)</code>',
  ...
  'justify-content': {
    ...
    'te': '<p>ప్రధాన అక్షంతో పాటు ఫ్లెక్స్ అంశాలను సమలేఖనం చేస్తుంది.</p><code>flex-start (default)</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code>',
