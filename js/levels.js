var levels = [
  ...
  },
  {
    ...
    instructions: {
      ...
      'it': '<p>Adesso usa <code>align-items</code> per aiutare le rane ad arrivare alla fine dello stagno. Questa proprieta\' CSS allinea gli elementi verticalmente ed accetta i seguenti valori:</p><ul><li><code>flex-start</code>: Allinea gli elementi all\'inizio del loro contenitore.</li><li><code>flex-end</code>: Allinea gli elementi alla fine del loro contenitore.</li><li><code>center</code>: Centra gli elementi verticalmente.</li><li><code>baseline</code>: Gli elementi sono allineati in modo tale che le loro baselines siano allineate.</li><li><code>stretch</code>: L\' altezza di ogni elemento viene estesa per occupare tutto il contenitore.</li></ul>'
    },
    board: 'gyr',
  ...
  },
  {
    ...
    instructions: {
      ...
      'it': '<p>Aiuta le rane a trovare la loro ninfea. Utilizza entrambe <code>flex-direction</code> e <code>justify-content</code> per dirigerle nella giusta posizione.</p><p>Nota che quando viene settata la direzione inversa per le righe o per le colonne, vengono invertiti anche i punti di start ed end.</p>'
    },
    board: 'gyr',
  ...
  },
  {
    ...
    instructions: {
      ...
      'it': '<p>Aiuta le rane a raggiungere le ninfee utilizzando <code>flex-direction</code> e <code>justify-content</code>.</p><p>Nota che quando la direzione flex e\' settata come column,  <code>justify-content</code> cambia l\'allineamento verticale e <code>align-items</code> quello orizzontale.</p>'
    },
    board: 'gyr',
  ...
  },
  {
    ...
    instructions: {
      ...
      'it': '<p>Aiuta le rane a raggiungere la rispettiva ninfea utilizzando <code>flex-direction</code> e <code>justify-content</code>.</p>',
    },
    board: 'gyr',
  ...
  },
  {
    ...
    instructions: {
      ...
      'it': '<p>Utilizza la proprieta\' <code>order</code> per muovere la rana rossa sulla rispettiva ninfea.</p>'
    },
    board: 'gggrg',
  ...
  },
  {
    ...
    instructions: {
      ...
      'it': '<p>Oh no! Le rane sono ora tutte schiacciate in una sola fila di ninfee. Dirigile al loro posto utilizzando <code>flex-wrap</code>, la quale accetta i seguenti valori:</p><ul><li><code>nowrap</code>: Ogni elemento viene sistemato nella stessa riga.</li><li><code>wrap</code>: Gli elementi vengono sistemati su piu\' righe se non ci stanno in una sola.</li><li><code>wrap-reverse</code>: Gli elementi vengono disposti su piu\' linee in ordine inverso.</li></ul>'
    },
    board: 'ygggggr',
